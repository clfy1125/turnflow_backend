...
```jsonc
{
  "servers": {
    "company-api-docs": {
      ...
      "env": {
        "OPENAPI_URL": "https://dev-api.turnflow.link/api/schema/"
      }
    }
  }
}
...
| 변수 | 기본값 | 설명 |
|------|--------|------|
| `OPENAPI_URL` | `https://dev-api.turnflow.link/api/schema/` | OpenAPI 스펙 URL (YAML/JSON). 구 ngrok URL은 폐기됨 — Cloudflare Tunnel 고정 URL 사용. |
