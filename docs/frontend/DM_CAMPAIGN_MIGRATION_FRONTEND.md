...
- 소요 시간: **게시물 수에 비례**(50개≈5분 · 500개≈50분). 백그라운드 실행, 폴링으로 진행률 표시.
  숫자를 하드코딩하지 말고 응답의 `estimate.seconds` 를 쓸 것 → `DM_MIGRATION_LONG_RUN_2026-08-17.md`
...
[DM 캠페인 이전] 클릭
  → IG 계정 선택 (여러 개면)
  → "최근 N개 게시물 분석" (기본 50, 최대 3000 — 2026-08-17 상한 확대)
