...
def _normalize_assignments(
    ...
    for a in assigns_raw:
        ...
        assigned[pid] = {
            ...
            "is_new_category": bool(a.get("is_new_category")) and label not in existing_labels,
...
def classify_posts(
    *,
    ...
    existing_labels = {
        (c.get("label") or "").strip() for c in (existing_categories or []) if c.get("label")
    }
    ...
    assignments, new_cats = _normalize_assignments(parsed, posts, existing_labels, max_categories)
